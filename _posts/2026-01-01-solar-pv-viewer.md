...
date: 2026-01-01
description: How to pull real-time generation data from a Fronius solar inverter's local API and build an AI-generated web dashboard to visualise it, CORS proxy included.
---
...
![Fronius solar inverter mounted on a wall](/assets/images/inverter.png)
...
![Line chart of solar generation versus house load over time](/assets/images/solarMonitorExample1.png)
