...
> [!IMPORTANT]
> I have a Fronius Inverter and so this guide is intended for Fronius Inverters only. Other Inverters will be similar though and you could use this guide for... inspiration.
...
> [!TIP]
> If you are up for it, I'd suggest you go to your home router, give your device a name and give it a static ip address so that it won't change. You can then goto your router and see what the ip address is if you need it. Much easier than the Fronius guide.
