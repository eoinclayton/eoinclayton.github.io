...
The Fronius inverter api url you want to you will be similar to: http://192.168.0.113/solar_api/v1/GetPowerFlowRealtimeData.fcgi
...
To help visualise what the Solar system is upto, we are going to need a website.
...
# Ugh, CORS!!!
The Cross-Origin Resource Sharing security protocol was introduced decades ago to help protect users making api calls via browsers, and has been making developer's lives difficult ever since :)
