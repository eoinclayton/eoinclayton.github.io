---
layout: post
title: USB Notification Light
date: 2026-02-01
description: Using a Delcom USB HID light and a small NodeJS/TypeScript script to turn PR reviews, JIRA tickets, and production incidents into an at-a-glance colour signal.
---
...
It's always good to help keep the team morale high, and to help with that, I installed a USB notification light in our pod in the office. Then, every time there was a sale the light glowed yellow like gold. Good times :) 

![Delcom USB notification light mounted above office desks](/assets/images/delcomLightAboveDesks.png)
...
Matching the industrial name of the [Delcom 904017-B](https://www.delcomproducts.com/products_USBLMP.asp), the light itself is also industrial in appearance. While not a beauty, it is sturdy: mine has lasted for 10+ years.
![Delcom 904017-B USB notification light close-up](/assets/images/delcomLight.png)

In addition to being durable, it also comes with [example code](https://www.delcomproducts.com/productdetails.asp?PartNumber=900000) showing you how to use it. I don't know about you, but my C++ and VB.Net are a bit rusty though. Time for a more modern language
